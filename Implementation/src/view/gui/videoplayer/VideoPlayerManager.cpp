            ...
            namespace videoplayer
            {
                    ...
                    , mIsStereo(false)
                {
                     ...
                     else if (cameraType == VideoPlayerTypes::VIDEO_MONO)
                     {
                         ...
                         OpenCVVideoPlayer* videoPlayer1 = new OpenCVVideoPlayer(0, "WebCam1", true, video2);
                     ...
                     else if (stereoType == VideoPlayerTypes::VIDEO_STEREO)
                     {
                         ...
                         OpenCVVideoPlayer* videoPlayer2 = new OpenCVVideoPlayer(0, "WebCam2", true, "../res/videos/sea.avi");
